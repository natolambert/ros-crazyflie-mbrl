...
class randController(Controller):
    def __init__(self, dynamics, dt_update, dt_control, variance = .00025):
        ...
        super(randController, self).__init__(dt_update, dt_control, dim=dim)
    ...
    def update(self, current_state, last_action,meanAdjust):
        ...
        if ((self.i % Rdt) == 0):
            ...
            #    et = time.time()
                ...
                #print "orig xsim appnd: ", seq_sim.shape
            #    X_sim.append(seq_sim)

            #print "original seq size: ", len(X_sim), X_sim[0].shape
            #print "\n\n\n\n\nDaTA ORIGINAL STUFF:::: ", X_sim[0], "\n\n\n\n\n"

            #print "data size: ", self.Objective.data.shape
            ################# new CUDA way of doing it #####################
            ...
            #X_sim = seq_sim_cuda
            #print "my sim seq size: ", len(X_sim), X_sim[0].shape
            ################# end new CUDA stuff ############################
            ...
            #print("seq_sim : ", (after_nn_time - before_nn_time)*1000)
...
#            mm_idx = self.Objective.compute_ARGmm_batch()
...
class Objective():
    ...
    def eval(self, input_array):
        ...
        val = self.optimizer(input_array)
        return val
